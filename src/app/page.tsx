...
const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    description:
      "Gathered requirements, acted as System Architect, led the dev team, created REST APIs, did UI-UX design, frontend and backend development, and mobility development. Managed Git, monitored progress, automated support activities (sms, email, telegram alerts, database backup), and managed Azure VMs. Maintained web & mobile applications for TMSA CV, PV and KYC, and TATA MOTORS PRODUCTS.",
    tags: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  },
  {
    ...
    entity: "SPINTeQ Automotive Products",
    description:
      "Auto schedule vehicle based on priority and availability of resources in workshop.",
    tags: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  },
  {
    ...
    entity: "SPINTeQ Automotive Products",
    description:
      "Workshop Management System, Asset Tracking, Analytics, Dashboards, Reports.",
    tags: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  },
  {
    ...
    entity: "SPINTeQ Automotive Products",
    description:
      "Admin Dashboard, Workshop Revenue Dashboard, Monitoring Dealer and Region Performance, Auto Sending Workshop Status & KPI messages.",
    tags: [
      "HTML",
      "CSS",
      "JavaScript",
...
const TimelineEventCard = ({
  ...
  return (
    <div
      className={`relative ${
        !isRightSide
          ? "md:pr-[calc(50%_+_1.5rem)]"
          : "md:pl-[calc(50%_+_1.5rem)]"
      }`}
    >
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <section id="home" className="py-24 md:py-32 text-center">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-2 text-lg md:text-xl text-muted-foreground">
              Creative Frontend Engineer & Design Enthusiast
            </h2>
            <p
              className="mt-4 max-w-2xl text-center text-muted-foreground"
              data-ai-hint="update this with your personal summary"
            >
              I craft beautiful, responsive, and user-centric web experiences.
              My passion lies in the intersection of clean code and thoughtful
              design.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <Button asChild variant="outline" size="lg">
                <a
                  href="/varun-miyani-resume.pdf"
                  download
                  data-ai-hint="Update this href to link to your actual resume file"
                >
      ...
      <footer className="py-8 border-t">
        <div className="container mx-auto px-4 text-center text-muted-foreground text-sm">
          <p>
            &copy; {new Date().getFullYear()} Varun Miyani. Built with Next.js
            and Tailwind CSS.
          </p>
        </div>
      </footer>
